...
export const images = () => {
    ...
    return app.gulp.src(
        ...
        .pipe(app.gulp.dest((file) => app.isWP ? getDestPath(file, app.path.prod.imgPhp) : app.path.prod.imgHtml))    // because, we need two file formats: one for browsers that support .webp and another for browsers that don't support .webp.
        ...
        .pipe(app.gulp.dest((file) => app.isWP ? getDestPath(file, app.path.prod.imgPhp) : app.path.prod.imgHtml))
